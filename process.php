        ...
        <main>
            ...
            if ($ok === true) {
                try {
                    ...
                    //if a value is stored in session variable, display the information
                    if (isset($_SESSION['fname'])) {

                        echo "<h2> Song added! Thanks for sharing " . $_SESSION['fname'] . " ! </h2>";
                    } else {
                        echo "<h2> Song added! Thanks for sharing! </h2>";
                    }
                    ...
                    mail('maitravijaypatel@gmail.com', 'TuneShare Error', 'Error :' . $error_message);
                }
            }
            ?>
            <a href="add.php" class="btn btn-lg btn-secondary orange"> Back to Form </a>
        </main>
